...
public class AccountsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addAccountFAB = view.findViewById(R.id.add_account_fbtn_account_fragment);
        cashAcCV = view.findViewById(R.id.cash_account_cv);;

        addAccountFAB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new ToastIntentClass(getActivity(), AddAccountActivity.class);
            }
        });

        cashAcCV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new ToastIntentClass(getActivity(), EditAccountActivity.class);
            }
        });
        return view;
    }
